...
<aside class="support-widget" data-support-widget aria-label="<?php esc_attr_e('Customer support', 'springapex'); ?>">
  <section class="support-panel" id="springapex-support-panel" data-support-panel hidden>
    <div class="support-panel-main">
      ...
      <div class="support-panel-body">
        <p class="support-intro"><?php esc_html_e('Send the essential details now. Our team will follow up for drawings or technical information.', 'springapex'); ?></p>
  ...
  <nav class="support-contact-dock" aria-label="<?php esc_attr_e('Direct contact options', 'springapex'); ?>">
    <?php if ($email !== '' && $email_href !== '') : ?>
      <a href="<?php echo esc_url($email_href); ?>" aria-label="<?php esc_attr_e('Email our team', 'springapex'); ?>">
    ...
    <?php if ($whatsapp !== '' && $whatsapp_href !== '') : ?>
      <a href="<?php echo esc_url($whatsapp_href); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Chat on WhatsApp', 'springapex'); ?>">
        <span class="support-contact-dock__icon"><?php echo springapex_icon('chat', 'icon'); ?></span>
