...
?>
<section class="section sa-process-detail" data-horizontal-scroll>
  <div class="container container-wide">
    <div class="sa-process-detail__pin" data-horizontal-pin>
      ...
      <div class="sa-process-detail__viewport" data-horizontal-viewport>
      <ol class="sa-process-detail__grid" data-horizontal-track data-reveal-group>
      ...
      <div class="sa-process-detail__dots" data-horizontal-dots aria-hidden="true">
        <?php foreach ($process as $index => $item) : ?>
          <span<?php echo $index === 0 ? ' class="is-active"' : ''; ?>></span>
        <?php endforeach; ?>
      </div>
      </div>
    </div>
