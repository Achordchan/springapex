    ...
    return [
        'company' => [
            ...
            'timeline_header' => [
                ...
                'title' => 'Built for repeat production.',
            ],
            'gallery' => [
        ...
        'resources' => [
            ...
            'library' => [
                'eyebrow' => 'AVAILABLE DOWNLOADS',
                'title' => 'Brochure Library Shelf',
                'text' => 'Corporate and product resources ready when you are.',
            ],
            'downloads' => [
                [
            ...
            'industry' => [
                'eyebrow' => 'INDUSTRY BROCHURES',
                'title' => 'Prepared for future industry libraries.',
                'status_text' => 'Awaiting approved file',
                'action_label' => 'Request an industry document',
                'action_href' => '/contact/?intent=catalog',
                'items' => ['Automotive', 'Industrial Equipment', 'Medical', 'Aerospace', 'Rail', 'Energy'],
            ],
            'items' => [
                [
        ...
        'sustainability' => [
            ...
            'lifecycle' => [
                ...
                'title' => 'Material Lifecycle Story',
                'text' => 'Responsibility is engineered through the full lifecycle of every spring we build.',
                ...
                'items' => [
                    [
                        ...
                        'points' => ['Qualified suppliers and documented material certificates.', 'Material choice aligned to strength, fatigue and corrosion needs.', 'Traceable records from incoming material to finished spring.'],
                    ...
                    [
                        ...
                        'points' => ['Production settings defined for the approved part and process.', 'Equipment condition and process parameters checked during production.', 'Housekeeping and safe-work responsibilities applied in daily operations.'],
                    ...
                    [
                        ...
                        'points' => ['Incoming material and in-process verification.', 'Final inspection to approved drawings and specifications.', 'Inspection and traceability records supplied as agreed.'],
                        'image' => 'generated/springapex-quality-lab-v1.webp',
                    ...
                    [
                        ...
                        'points' => ['Protective packaging selected around part size and finish.', 'Clear identification for part number, lot and quantity.', 'Export-ready documentation prepared to project requirements.'],
            ...
            'management' => [
                ...
                'title' => 'Certified systems. Verified records.',
                'text' => 'Environmental and occupational health and safety management systems provide the framework for responsible operations and continual improvement.',
                'action_label' => 'View all certificates',
                'action_href' => '/about/#quality-certificates',
            ],
            'safety' => [
                'eyebrow' => 'SAFE WORK',
                'title' => 'Safe work supports dependable production.',
                'text' => 'The occupational health and safety management system defines responsibilities, training and workplace controls that support people and consistent production.',
                'image' => 'generated/springapex-news-quality-audit-v1.webp',
                'image_alt' => 'Spring inspection under documented quality and safety procedures',
                'points' => ['Documented responsibilities and operating procedures.', 'Training aligned to assigned work and equipment.', 'Routine checks and continual improvement of workplace controls.'],
            ],
            'progress' => [
                'eyebrow' => 'TRANSPARENT PROGRESS',
                'title' => 'Progress we can document.',
                'text' => 'Certifications, management-system scope and supporting records can be shared for supplier audits and qualification reviews. Contact our engineering team for the documentation your programme requires.',
                'primary_label' => 'Contact Engineering',
                'primary_href' => '/contact/?intent=sustainability',
                'secondary_label' => 'Open Download Center',
