...
$solution_post = springapex_singular_post_for_view('spring_solution');
if ($solution_post) {
    $slug = (string) $solution_post->post_name;
    $solution = springapex_solution_detail_from_post($solution_post);
}
