...
<section class="section sa-custom-brief">
  <div class="container container-wide sa-custom-brief__grid">
    ...
    <div class="sa-custom-brief__content" data-reveal="up">
      ...
      <a class="btn btn-secondary sa-custom-brief__action" href="<?php echo esc_url(springapex_url('/contact/?intent=drawing')); ?>">
        <?php esc_html_e('Send Your Project Details', 'springapex'); ?> <?php echo springapex_icon('arrow-right', 'icon icon-sm'); ?>
      </a>
    </div>
  </div>
</section>
...
get_template_part('parts/cta-band', null, [
    'title' => 'Bring Us Your Most Demanding Application.',
